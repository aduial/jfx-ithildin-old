...
public class RelatedView{
    ...
    private static final long serialVersionUID = 787878784L;
    ...
    private final IntegerProperty lorder        = new SimpleIntegerProperty();
    ...
    public void setLorder(int value) {
        lorder.set(value);
    }

    public IntegerProperty lorderProperty() {
        return lorder;
    }
