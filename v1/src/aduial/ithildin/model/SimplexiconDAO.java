...
public class SimplexiconDAO{
    ...
    public static ObservableList<Simplexicon> searchByForm(String term, Integer langId) throws SQLException,
                                                                                               ClassNotFoundException {
        String selectStmt = "SELECT * FROM simplexicon WHERE form like '%" + term + "%' AND language_id = " + langId
                .toString() + ";";
        ...
        try {
            ...
            System.out.println(
                    "While searching an Simplexicon containing search " + "term %" + term + "% in FORM value, an error occurred: " + e);
            throw e;
        }
    }

    public static ObservableList<Simplexicon> searchByGloss(String term, Integer langId) throws SQLException,
                                                                                                ClassNotFoundException {
        String selectStmt = "SELECT * FROM simplexicon WHERE gloss like '%" + term + "%' AND language_id = " + langId
                .toString() + ";";
        ...
        try {
            ...
            System.out.println(
                    "While searching an Simplexicon containing search " + "term %" + term + "% in GLOSS value, an error occurred: " + e);
            throw e;
        }
    }

    private static Simplexicon getSimplexiconFromResultSet(ResultSet rs) throws SQLException {
    ...
    private static ObservableList<Simplexicon> getSimplexiconList(ResultSet rs) throws SQLException,
                                                                                       ClassNotFoundException {
