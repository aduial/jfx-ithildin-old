...
//    System.out.println("Thou clicketh: " + selected.getId());
    ...
    currentLexiconPage = new LexiconPage(selectedLexicon, 
            refToggleButton.isSelected(), 
            glsToggleButton.isSelected(), 
            drvToggleButton.isSelected(), 
            iflToggleButton.isSelected(), 
            elmToggleButton.isSelected(), 
