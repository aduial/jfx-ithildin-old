...
public class DerivView {
    ...
    private static final long serialVersionUID = 4348923476L;
    ...
    private final StringProperty entrygloss = new SimpleStringProperty();
    private final StringProperty refgloss = new SimpleStringProperty();
    ...
    public String getEntrygloss() {
      return entrygloss.get();
    }

    public void setEntrygloss(String value) {
      entrygloss.set(value);
    }

    public StringProperty entryglossProperty() {
        return entrygloss;
    }
    ...
    public void setRefgloss(String value) {
      refgloss.set(value);
    }

    public StringProperty refglossProperty() {
        return refgloss;
    }
